...
from aletheus.autonomous_operations.drift_detection.engine import Engine


def test_drift_detection_is_bounded_and_deterministic() -> None:
    ...
    _ = (event, sample)
    result = Engine().detect(mission, mission.objective, ())
