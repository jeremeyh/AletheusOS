...
def render(state):
    ...
    with tab2:
        st.info(
            "Acquisition AI evaluates purchase price, upside, capital impact, and alternatives."
        )

    with tab3:
        st.info(
            "Exit Intelligence recommends hold, sell, grade, auction, consign, vault, trade, or bundle."
        )
