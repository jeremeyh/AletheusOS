...
FAMILY_ID = '112.23.1-112.23.9.1'
FAMILY_TITLE = 'Capability Composition & Dependency Fabric'
TERMINAL_STATUS = 'GENESIS_112_23_CAPABILITY_COMPOSITION_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'capability-composition-fabric'
PHASES = (('112.23.1', 'Canonical Capability Composition Contract'), ('112.23.2', 'Capability Dependency Resolution Engine'), ('112.23.3', 'Capability Composition Graph'), ('112.23.4', 'Dependency Readiness & Availability Propagation'), ('112.23.5', 'Capability Interface Compatibility & Version Contract'), ('112.23.6', 'Capability Isolation & Failure Domain Architecture'), ('112.23.7', 'Dynamic Composition & Bounded Reconfiguration'), ('112.23.8', 'Composition Adversarial & Dependency Failure Validation'), ('112.23.9', 'Capability Composition Fabric Master Closure'), ('112.23.9.1', 'External RAF Certification & Gold Seal'))
ANCHORS = ('COMPOSITION', 'DEPENDENCY', 'COMPATIBILITY', 'FAILURE_DOMAIN', 'RECONFIGURATION')
REQUIRED_PATHS = ('aletheus/platform_capability_fabric',)
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'platform-capability-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_22_PLATFORM_CAPABILITY_FABRIC_PROJECT_CERTIFIED'
