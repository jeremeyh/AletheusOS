...
class RegistryFederationValidator:
    ...
    def validate(self):
        ...
        registry_map = self.load("registry_map.json")

        report = self.load("wiring_report.json")

        result = {
            "registries_detected": len(registry_map),
...
if __name__ == "__main__":
    ...
    print(json.dumps(validator.validate(), indent=2))
