...
class ExecutivePolicyError(ConstitutionalRuntimeExecutiveError):
    """Raised when executive policy evaluation fails."""


class ExecutiveDecisionError(ConstitutionalRuntimeExecutiveError):
    """Raised when an executive decision is invalid."""


class RecoveryPlanError(ConstitutionalRuntimeExecutiveError):
