...
FAMILY_ID = '112.25.1-112.25.9.1'
FAMILY_TITLE = 'Multiplicitous Intelligence Integration Fabric'
TERMINAL_STATUS = 'GENESIS_112_25_MULTIPLICITOUS_INTELLIGENCE_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'multiplicitous-intelligence-fabric'
PHASES = (('112.25.1', 'Canonical Intelligence Capability Contract'), ('112.25.2', 'Intelligence Capability Reconnaissance & Authority Reconciliation'), ('112.25.3', 'Intelligence Dispatcher & Routing Contract'), ('112.25.4', 'Parallel Specialist Invocation Fabric'), ('112.25.5', 'Evidence / Knowledge / Reasoning Context Exchange'), ('112.25.6', 'Consensus, Disagreement & Abstention Protocol'), ('112.25.7', 'Confidence / Provenance / Uncertainty Propagation'), ('112.25.8', 'Intelligence Fabric Adversarial Truthfulness Validation'), ('112.25.9', 'Multiplicitous Intelligence Fabric Master Closure'), ('112.25.9.1', 'External RAF Certification & Gold Seal'))
ANCHORS = ('INTELLIGENCE', 'DISPATCH', 'CONSENSUS', 'ABSTENTION', 'PROVENANCE', 'UNCERTAINTY')
REQUIRED_PATHS = ('aletheus/intelligence', 'aletheus/knowledge', 'aletheus/reasoning')
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'platform-orchestration-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_24_PLATFORM_ORCHESTRATION_FABRIC_PROJECT_CERTIFIED'
