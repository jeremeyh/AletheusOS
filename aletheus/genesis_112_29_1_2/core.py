...
FAMILY_ID = '112.29.1-112.29.2'
FAMILY_TITLE = 'Unified Platform Architecture Reconciliation & Constitutional Integration Harness'
TERMINAL_STATUS = 'GENESIS_112_29_2_UNIFIED_PLATFORM_INTEGRATION_HARNESS_READY'
REPORT_FAMILY = 'unified-platform-integration'
PHASES = (('112.29.1', 'Unified Platform Architecture Reconciliation'), ('112.29.2', 'Unified Platform Constitutional Integration Harness'))
ANCHORS = ('SERVICE_FABRIC', 'CAPABILITY_FABRIC', 'COMPOSITION', 'ORCHESTRATION', 'INTELLIGENCE', 'OBSERVATION', 'GOVERNANCE', 'ECOSYSTEM')
REQUIRED_PATHS = ('aletheus/platform_service_fabric', 'aletheus/platform_capability_fabric', 'aletheus/mammoth', 'aletheus/rsf', 'aletheus/raf')
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'ecosystem-integration-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_28_ECOSYSTEM_INTEGRATION_FABRIC_PROJECT_CERTIFIED'
