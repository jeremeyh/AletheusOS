...
class Engine:
    """Evidence Provenance Chronicle capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.14.0"
    CAPABILITY: ClassVar[str] = "Evidence Provenance Chronicle"
