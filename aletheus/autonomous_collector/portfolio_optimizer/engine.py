...
class Engine:
    """Portfolio Fit Optimizer capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.11.0"
    CAPABILITY: ClassVar[str] = "Portfolio Fit Optimizer"
