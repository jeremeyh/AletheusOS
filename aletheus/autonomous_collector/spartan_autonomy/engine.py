...
class Engine:
    """SPARTAN Autonomous Security capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.13.0"
    CAPABILITY: ClassVar[str] = "SPARTAN Autonomous Security"
