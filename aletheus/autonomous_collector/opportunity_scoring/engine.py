...
class Engine:
    """Opportunity Scoring Engine capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.5.0"
    CAPABILITY: ClassVar[str] = "Opportunity Scoring Engine"
