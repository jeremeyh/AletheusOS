...
class Engine:
    """Autonomous Collector Core capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.0.0"
    CAPABILITY: ClassVar[str] = "Autonomous Collector Core"
