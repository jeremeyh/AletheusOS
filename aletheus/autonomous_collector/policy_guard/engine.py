...
class Engine:
    """Collector Policy Guard capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.4.0"
    CAPABILITY: ClassVar[str] = "Collector Policy Guard"
