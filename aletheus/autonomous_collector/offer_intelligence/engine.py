...
class Engine:
    """Offer Negotiation Intelligence capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.9.0"
    CAPABILITY: ClassVar[str] = "Offer Negotiation Intelligence"
