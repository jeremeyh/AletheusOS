...
class Engine:
    """Opportunity Discovery Mesh capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.2.0"
    CAPABILITY: ClassVar[str] = "Opportunity Discovery Mesh"
