...
class Engine:
    """Assisted Decision Engine capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.8.0"
    CAPABILITY: ClassVar[str] = "Assisted Decision Engine"
