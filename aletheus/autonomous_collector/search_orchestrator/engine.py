...
class Engine:
    """Proactive Search Orchestrator capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.7.0"
    CAPABILITY: ClassVar[str] = "Proactive Search Orchestrator"
