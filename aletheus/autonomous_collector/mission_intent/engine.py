...
class Engine:
    """Mission Intent Runtime capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.1.0"
    CAPABILITY: ClassVar[str] = "Mission Intent Runtime"
