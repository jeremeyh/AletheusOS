...
class Engine:
    """Watchlist Signal Intelligence capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.6.0"
    CAPABILITY: ClassVar[str] = "Watchlist Signal Intelligence"
