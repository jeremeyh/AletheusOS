...
class Engine:
    """Budget and Capital Guardrails capability for bounded, evidence-first collector autonomy."""

    VERSION: ClassVar[str] = "32.10.0"
    CAPABILITY: ClassVar[str] = "Budget and Capital Guardrails"
