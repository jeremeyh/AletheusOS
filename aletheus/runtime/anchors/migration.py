...
class AnchorRuntimeMigrationEngine:
    ...
    def create_plan(self, anchor):

        deployment = self.deployment.prepare(anchor)
    ...
    def execute(self, migration):

        migration["state"] = {"captured": True, "transferred": True, "validated": True}
    ...
    def snapshot(self):
        ...
        return {"migration_count": len(self.migrations)}
