...
class AnchorProposalEngine:
    def __init__(self, research, simulation, governance):
    ...
    def generate(self, anchor):
        ...
        research = self.research.analyze(anchor)
        ...
        proposal = {
            ...
            "evidence": {"source": "anchor_research"},
    ...
    def calculate_confidence(self, research):
    ...
    def submit(self, proposal):
        ...
        decision = self.governance.evaluate(proposal["anchor"], proposal)

        proposal["governance"] = decision

        proposal["status"] = "approved" if decision["approved"] else "review"
    ...
    def snapshot(self):
        ...
        return {"proposal_count": len(self.proposals)}
