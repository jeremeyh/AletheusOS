...
from aletheus.runtime.registrations.application_commands import (
    register_application_commands,
)
from aletheus.runtime.registrations.architecture_commands import (
    register_architecture_commands,
)
from aletheus.runtime.registrations.cluster_commands import register_cluster_commands
from aletheus.runtime.registrations.compatibility_alias_commands import (
    register_compatibility_alias_commands,
)
from aletheus.runtime.registrations.compatibility_commands import (
...
from aletheus.runtime.registrations.enterprise_commands import (
    register_enterprise_commands,
)
from aletheus.runtime.registrations.event_commands import register_event_commands
from aletheus.runtime.registrations.executive_commands import (
    register_executive_commands,
)
from aletheus.runtime.registrations.federation_commands import (
    register_federation_commands,
)
from aletheus.runtime.registrations.governance_architecture_commands import (
    register_architecture_governance_commands,
)
from aletheus.runtime.registrations.governance_commands import (
    register_governance_commands,
)
...
from aletheus.runtime.registrations.kernel_compatibility_commands import (
    register_kernel_compatibility_commands,
)
from aletheus.runtime.registrations.knowledge_graph_commands import (
    register_knowledge_graph_commands,
)
...
from aletheus.runtime.registrations.memory_mesh_commands import (
    register_memory_mesh_commands,
)
from aletheus.runtime.registrations.mission_commands import register_mission_commands
from aletheus.runtime.registrations.mission_v2_commands import (
    register_mission_v2_commands,
)
...
from aletheus.runtime.registrations.prediction_commands import (
    register_prediction_commands,
)
...
from aletheus.runtime.registrations.release_commands import register_release_commands
...
from aletheus.runtime.registrations.telemetry_commands import (
    register_telemetry_commands,
)
...
from aletheus.runtime.registrations.workflow_commands import register_workflow_commands
from aletheus.runtime.registrations.workflow_v2_commands import (
    register_workflow_v2_commands,
)
from aletheus.runtime.registrations.workspace_commands import (
...
class RuntimeCommandBootstrapper:
    ...
    def bootstrap(self, runtime):
        ...
        # Final compatibility compilation phase.
        #
        # Canonical and guarded legacy families must exist before aliases
        # are resolved. Specialized compatibility registrations then receive
        # final authority over their public command contracts.
        register_compatibility_alias_commands(runtime)
        register_mission_v2_commands(runtime)
        register_workflow_v2_commands(runtime)
        register_kernel_compatibility_commands(runtime)
