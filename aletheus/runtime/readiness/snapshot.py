...
class RuntimeReadinessSnapshot:
    ...
    def generate(self, runtime):
        ...
        return {
            ...
            "registry": (
                runtime.registry.snapshot() if hasattr(runtime, "registry") else None
            ),
            ...
            "boot_certification": (
                ...
                if hasattr(runtime, "boot_certification_validate")
                else None
            ),
            "spa": (runtime.spa.assess() if hasattr(runtime, "spa") else None),
        }
