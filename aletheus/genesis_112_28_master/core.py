...
FAMILY_ID = '112.28.1-112.28.9.1'
FAMILY_TITLE = 'Ecosystem Integration & Application Attachment Fabric'
TERMINAL_STATUS = 'GENESIS_112_28_ECOSYSTEM_INTEGRATION_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'ecosystem-integration-fabric'
PHASES = (('112.28.1', 'Canonical Application Attachment Contract'), ('112.28.2', 'Native Application Integration Architecture'), ('112.28.3', 'SDK / API Capability Exposure Architecture'), ('112.28.4', 'A•3ye Satellite Capability Attachment'), ('112.28.5', 'External / OEM Integration Boundary'), ('112.28.6', 'Identity / Tenant / Consumer Isolation'), ('112.28.7', 'Application Capability Discovery & Negotiation'), ('112.28.8', 'Ecosystem Boundary / Unauthorized Capability Access Validation'), ('112.28.9', 'Ecosystem Integration Fabric Master Closure'), ('112.28.9.1', 'External RAF Certification & Gold Seal'))
ANCHORS = ('APPLICATION', 'SDK', 'API', 'A3YE', 'OEM', 'TENANT', 'DISCOVERY')
REQUIRED_PATHS = ('aletheus/applications', 'aletheus/sdk')
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'constitutional-capability-governance-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_27_CONSTITUTIONAL_GOVERNANCE_FABRIC_PROJECT_CERTIFIED'
