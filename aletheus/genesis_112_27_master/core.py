...
FAMILY_ID = '112.27.1-112.27.9.1'
FAMILY_TITLE = 'Constitutional Capability Governance Fabric'
TERMINAL_STATUS = 'GENESIS_112_27_CONSTITUTIONAL_GOVERNANCE_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'constitutional-capability-governance-fabric'
PHASES = (('112.27.1', 'Constitutional Capability Governance Contract'), ('112.27.2', 'Principle X / Constitutional Authority Attachment'), ('112.27.3', 'Constitutional Virtues Behavioral Contract'), ('112.27.4', 'Capability Permission & Authority Enforcement'), ('112.27.5', 'Evidence / Provenance Requirements for Governed Decisions'), ('112.27.6', 'Risk, Bias & Uncertainty Governance Integration'), ('112.27.7', 'Constitutional Refusal / Abstention / Escalation Fabric'), ('112.27.8', 'Governance Bypass & Authority-Escalation Adversarial Validation'), ('112.27.9', 'Constitutional Governance Fabric Master Closure'), ('112.27.9.1', 'External RAF Certification & Gold Seal'))
ANCHORS = ('PRINCIPLE_X', 'TRUTH', 'INTEGRITY', 'HUMILITY', 'COMPASSION', 'KINDNESS', 'AGAPE', 'JUSTICE', 'WISDOM')
REQUIRED_PATHS = ('aletheus/runtime/governance', 'aletheus/raf', 'aletheus/rsf')
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'platform-observation-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_26_OPERATIONAL_INTELLIGENCE_FABRIC_PROJECT_CERTIFIED'
