...
FAMILY_ID = '112.26.1-112.26.9.1'
FAMILY_TITLE = 'Platform Observation & Operational Intelligence Fabric'
TERMINAL_STATUS = 'GENESIS_112_26_OPERATIONAL_INTELLIGENCE_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'platform-observation-fabric'
PHASES = (('112.26.1', 'Canonical Platform Observation Contract'), ('112.26.2', 'Runtime / Service / Capability Telemetry Reconciliation'), ('112.26.3', 'Unified Health & Readiness Model'), ('112.26.4', 'Operational Topology Observation'), ('112.26.5', 'Failure Domain & Dependency Impact Analysis'), ('112.26.6', 'Runtime Diagnostics / Doctor / Inspector Composition'), ('112.26.7', 'RSF Reliability Observation Integration'), ('112.26.8', 'Observation Integrity & False-Health Adversarial Validation'), ('112.26.9', 'Operational Intelligence Fabric Master Closure'), ('112.26.9.1', 'External RAF Certification & Gold Seal'))
ANCHORS = ('OBSERVATION', 'HEALTH', 'READINESS', 'TELEMETRY', 'DIAGNOSTICS', 'FAILURE_IMPACT')
REQUIRED_PATHS = ('aletheus/runtime', 'aletheus/rsf')
ROOT_ANCESTOR = ''
PREDECESSOR_REPORT_FAMILY = 'multiplicitous-intelligence-fabric'
PREDECESSOR_STATUS = 'GENESIS_112_25_MULTIPLICITOUS_INTELLIGENCE_FABRIC_PROJECT_CERTIFIED'
