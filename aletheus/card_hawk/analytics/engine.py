...
class CardHawkAnalyticsEngine:
    def __init__(self):
        ...
        self.allocation = AllocationAnalyticsEngine()

        self.exposure = ExposureAnalyticsEngine()

    def analyze(self, assets):

        return {
            "performance": self.performance.analyze(assets),
            "allocation": self.allocation.analyze(assets),
            "exposure": self.exposure.analyze(assets),
        }
