...
FAMILY_ID = '112.22.2-112.22.9.1'
FAMILY_TITLE = 'Platform Capability Integration Fabric'
TERMINAL_STATUS = 'GENESIS_112_22_PLATFORM_CAPABILITY_FABRIC_PROJECT_CERTIFIED'
REPORT_FAMILY = 'platform-capability-fabric'
PHASES = (('112.22.2', 'Capability Authority Provenance & Attachment Evidence Reconciliation'), ('112.22.3', 'Canonical Capability Contract & Authority Registry'), ('112.22.4', 'Capability Attachment Adapter Architecture'), ('112.22.5', 'Capability Dependency & Connection Mesh'), ('112.22.6', 'Capability Lifecycle Integration'), ('112.22.7', 'Capability Persistence & Reliability Integration'), ('112.22.8', 'Capability Fabric Adversarial Validation'), ('112.22.9', 'Platform Capability Fabric Master Closure'), ('112.22.9.1', 'External RAF Project Certification & Gold Seal'))
ANCHORS = ('ENGINE', 'FRAMEWORK', 'INTELLIGENCE', 'SECURITY', 'PERCEPTION', 'APPLICATION_FACING')
REQUIRED_PATHS = ('aletheus/platform_capability_fabric/genesis_112_22_1', 'aletheus/platform_service_fabric/genesis_112_21_master', 'aletheus/mammoth', 'aletheus/rsf', 'aletheus/raf')
ROOT_ANCESTOR = 'sha256:73bc7850b433461c44e9f27532c0133239ea39e5cc967a40c2fb0de51f58108c'
PREDECESSOR_REPORT_FAMILY = 'platform-capability-fabric'
PREDECESSOR_STATUS = 'CANONICAL_CAPABILITY_IDENTITY_OWNERSHIP_ATTACHMENT_READY'
