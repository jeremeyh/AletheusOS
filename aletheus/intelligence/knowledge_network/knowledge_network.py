...
class UniversalKnowledgeNetwork:
    ...
    def create_node(self, concept, domain):
        ...
        self.nodes[node["knowledge_id"]] = node
    ...
    def map_context(self, knowledge_id, context):

        self.context[knowledge_id] = context

        return {"knowledge_id": knowledge_id, "context_added": True}

    def discover_connections(self, concept):
